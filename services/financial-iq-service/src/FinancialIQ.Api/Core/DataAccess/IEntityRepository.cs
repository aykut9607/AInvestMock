...
namespace FinancialIQ.Api.Core.DataAccess;
...
public interface IEntityRepository<T>where T : class, IEntity, new()
{
    ...
    //Task is like a promise in JavaScript. it is a way to handle asynchronous operations- and a way to handle operations that take time to complete
